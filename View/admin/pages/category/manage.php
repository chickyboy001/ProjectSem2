                                ...
                                <tbody>
                                    ...
                                    foreach ($categories as $category) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-sm btn-outline-info" data-bs-toggle="modal" data-bs-target="#modal<?= $stt ?>">
                                                    <lord-icon src="https://cdn.lordicon.com/alzqexpi.json" trigger="hover" style="width:20px;height:20px">
                                                    </lord-icon>
                                                </button>
                                                <div class="modal fade" id="modal<?= $stt ?>" tabindex="-1" aria-labelledby="modal<?= $stt ?>" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content text-start">
                                                            ...
                                                            <form id="form<?= $stt ?>" method="post" enctype="multipart/form-data">
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" name="updateCateName" class="form-control" id="newCateName" value="<?= $category['category_name'] ?>" pattern=".{5,}" title="Tên danh mục không ít hơn 5 kí tự" required>
                                                                    </div>
                                                                    <?php
                                                                    $status = '';
                                                                    ...
                                                                    <div class="form-check form-switch">
                                                                        <input class="form-check-input" id="status<?= $stt ?>" onclick="changeStatusCate(<?= $stt ?>)" value="<?= $category['status'] ?>" name="statusCate" type="checkbox" role="switch" <?= $status ?>>
                                                                        <label class="form-check-label" for="status<?= $stt ?>">Hiện
                                                                            danh mục này</label>
                                                                    </div>
                                                                </div>
                    ...
                    <div class="bg-light rounded h-100 p-4">
                        ...
                        <form method="post" enctype="multipart/form-data">
                            <div class="mb-3">
                                ...
                                <input type="text" name="CategoryName" class="form-control" id="cateNameInput" pattern=".{5,}" title="Tên danh mục không ít hơn 5 kí tự" required>
                                
                            </div>
                            <div class="m-n2">
                                <button type="submit" name="addCategoryName" class="btn btn-outline-primary m-2">
                                    <lord-icon class="me-2" src="https://cdn.lordicon.com/cnnjfbvo.json" trigger="morph" style="width:20px;height:20px">
                                    </lord-icon>Xác nhận
                                </button>
                            </div>
                        </form>
