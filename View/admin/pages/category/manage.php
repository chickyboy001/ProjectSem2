            ...
            <div class="navbar-nav w-100">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-transparent border-0">
                        ...
                        <a href="?controller=addCategory" class="dropdown-item active">Quản lý danh mục</a>
                    </div>
                </div>
        ...
        <div class="container-fluid pt-4 px-4">
            <div class="bg-light rounded p-4">
                ...
                <div class="table-responsive">
                    <table id="categoryTable" class="table text-center align-middle table-bordered table-hover mb-0">
                        <thead>
                            <tr class="text-dark">
                                <th scope="col">#</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-outline-primary" href=" ">
                                        <lord-icon src="https://cdn.lordicon.com/rfbqeber.json" trigger="hover"
