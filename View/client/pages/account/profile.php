...
<div class="container">
        <div class="row">
            <div class="col-md-2 col-lg-2 col-xs-12 col-sm-12">
                <ul class="myinfo">
                    <li class="iteminfo">
                        <a href="/profile.php?name=<?php echo $row_profile['user_name'] ?>">
                            <b> Tài khoản của tôi </b>
                        </a>
                    </li>
                    <li class="iteminfo">
                        <a href="/editProfile.php?name=<?php echo $row_profile['user_name'] ?>">
                            Thông tin cá nhân
                        </a>
                    </li>
                    <li class="iteminfo">
                        <a href="/historyOrder.php?name=<?php echo $row_profile['user_name'] ?>">
                            Lịch sử đơn hàng
                        </a>
                    </li>
                    <li class="iteminfo">
