...
<head>
    ...
    <link href="../../../ProjectSem2/Assets/admin/css/accountForm.css" rel="stylesheet">
                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h3 class="text-primary">DOUBLE H</h3>
                            <h3>Đăng nhập</h3>
                        </div>
                        <div class="form-floating mb-3">
                            <input autofocus autocomplete="on" type="text" class="form-control" id="floatingInput" placeholder="Tên người dùng ">
                            <label for="floatingInput ">Tên người dùng</label>
                        </div>
                        <div class="form-floating mb-4 ">
                            <input autocomplete="on" type="password" class="form-control" id="floatingPassword" placeholder="Mật khẩu">
                        ...
                        <button type="submit" class="btn btn-primary py-3 w-100 ">Đăng nhập</button>
                    </div>
                </div>
            </div>
        </div>
