    ...
    <main class="row">
        <div class="body-success">
            <div class="card-success">
                ...
                <h1 class="h1-success">Đặt hàng thành công</h1>
                <p class="p-success"> Chúng tôi đã nhận được yêu cầu mua hàng của bạn</p>
                <button class="btn btn-dark mt-4" style="background-color: green;"> <a href="?controller=home" style="text-decoration: none; color: white">Tiếp tục mua sắm</a></button>
            </div>
        </div>
