    ...
    <div class="row">
        <div class="col-lg-auto">
            <div class="site-logo text-center text-lg-left">
                <a href="">Double-<span class="animate-charcter">H</span></a>
            </div>
        </div>
                ...
                <div class="col-lg-5 col-md-12 mb-3">
                    ...
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-sm-2 col-3">
                                <div class="img-small border" style="background-image: url('../../../ProjectSem2/Public/admin/upload/products/DataModelShoes.png')" data-src="../../../ProjectSem2/Public/admin/upload/products/DataModelShoes.png"></div>
                            </div>
                            <div class="col-sm-2 col-3">
                                <div class="img-small border" style="background-image: url('../../../ProjectSem2/Public/admin/upload/products/ezgif-5-9b70b8b517.jpg')" data-src="../../../ProjectSem2/Public/admin/upload/products/ezgif-5-9b70b8b517.jpg"></div>
                            </div>
                        ...
                        <div class="row ms-3">
                            ...
                            <div class="w-10 mt-3">
                                ...
                                foreach ($colors as $color) { ?>
                                    <button style="width:100%;" onclick="sendColorName(<?= $color['color_name']?>)" type="button"><img class="d-block" style="width: 10%;"  src="../../../ProjectSem2/Public/admin/upload/products/<?= $color['image_link'] ?>" class="img-fluid"></button>
                                    <input type="hidden" id="chooseCl" name="colorId" />
                                    <?php } ?>
                                </div>
                            </div>
                            <div class="col-xl-5 col-md-9 col-sm-3 col-5 mx-auto mt-3">
                                <div class="mb-3">
                                    <label for="qty">Chọn màu sắc</label>
                            ...
                            <div class="col-12 mt-3">
                                <button class="btn btn-outline-secondary btn-sm" type="button"><i class="fas fa-heart me-2"></i>Thêm vào yêu thích</button>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <ul class="rating-list mt-3">
                                            <li>
                                                <div class="progress">
                                                    <div class="progress-bar bg-dark" role="progressbar" style="width: 80%;" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100">45%</div>
                                                </div>
