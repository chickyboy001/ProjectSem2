 ...
 *   https://datatables.net/download/#bs5/dt-1.12.1/fc-4.1.0/r-2.3.0/rr-1.2.8/sc-2.0.7/sb-1.3.4/sp-2.0.2
 *
 * Included libraries:
 *   DataTables 1.12.1, FixedColumns 4.1.0, Responsive 2.3.0, RowReorder 1.2.8, Scroller 2.0.7, SearchBuilder 1.3.4, SearchPanes 2.0.2
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5/dt-1.12.1/fc-4.1.0/r-2.3.0/rr-1.2.8/sc-2.0.7/sb-1.3.4/sp-2.0.2",
